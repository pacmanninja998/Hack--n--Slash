...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\ManA.lua 

local Entity = require("Entity")
local ManA = require("Class").create(Entity, "ManA")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
ManA.FRAMES_PER_SECOND = 15
ManA.ANIM_NAME = "ManA"
ManA.DEFAULT_SCALE = 0.8
ManA.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
