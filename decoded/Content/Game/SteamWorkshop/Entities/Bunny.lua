...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\Bunny.lua 

local Entity = require("Entity")
local Bunny = require("Class").create(Entity, "Bunny")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
Bunny.FRAMES_PER_SECOND = 15
Bunny.ANIM_NAME = "Bunny"
Bunny.DEFAULT_SCALE = 0.8
Bunny.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
