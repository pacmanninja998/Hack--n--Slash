...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\WomanA.lua 

local Entity = require("Entity")
local WomanA = require("Class").create(Entity, "WomanA")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
WomanA.FRAMES_PER_SECOND = 15
WomanA.ANIM_NAME = "WomanA"
WomanA.DEFAULT_SCALE = 0.8
WomanA.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
