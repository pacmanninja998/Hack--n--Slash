...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\Bug.lua 

local Entity = require("Entity")
local Bug = require("Class").create(Entity, "Bug")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
Bug.FRAMES_PER_SECOND = 15
Bug.ANIM_NAME = "Bug"
Bug.DEFAULT_SCALE = 0.5
Bug.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
