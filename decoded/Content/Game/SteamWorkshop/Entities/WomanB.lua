...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\WomanB.lua 

local Entity = require("Entity")
local WomanB = require("Class").create(Entity, "WomanB")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
WomanB.FRAMES_PER_SECOND = 15
WomanB.ANIM_NAME = "WomanB"
WomanB.DEFAULT_SCALE = 0.8
WomanB.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
