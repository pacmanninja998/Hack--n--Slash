...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\KidA.lua 

local Entity = require("Entity")
local KidA = require("Class").create(Entity, "KidA")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
KidA.FRAMES_PER_SECOND = 15
KidA.ANIM_NAME = "KidA"
KidA.DEFAULT_SCALE = 0.8
KidA.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
