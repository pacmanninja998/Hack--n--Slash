...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\Beetle.lua 

local Entity = require("Entity")
local Beetle = require("Class").create(Entity, "Beetle")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
Beetle.FRAMES_PER_SECOND = 15
Beetle.ANIM_NAME = "Beetle"
Beetle.DEFAULT_SCALE = 0.4
Beetle.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
