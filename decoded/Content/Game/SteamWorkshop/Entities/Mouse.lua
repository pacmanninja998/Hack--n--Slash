...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\Mouse.lua 

local Entity = require("Entity")
local Mouse = require("Class").create(Entity, "Mouse")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
Mouse.FRAMES_PER_SECOND = 15
Mouse.ANIM_NAME = "Mouse"
Mouse.DEFAULT_SCALE = 0.2
Mouse.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
