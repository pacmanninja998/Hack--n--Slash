...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\Shrub.lua 

local Entity = require("Entity")
local Shrub = require("Class").create(Entity, "Shrub")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
Shrub.FRAMES_PER_SECOND = 15
Shrub.ANIM_NAME = "Shrub"
Shrub.DEFAULT_SCALE = 0.8
Shrub.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
