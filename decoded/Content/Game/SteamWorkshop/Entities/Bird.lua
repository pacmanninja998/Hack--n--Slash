...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\SteamWorkshop\Entities\Bird.lua 

local Entity = require("Entity")
local Bird = require("Class").create(Entity, "Bird")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
local SoundComponent = require("Components.SoundComponent")
Bird.FRAMES_PER_SECOND = 15
Bird.ANIM_NAME = "Bird"
Bird.DEFAULT_SCALE = 0.8
Bird.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
