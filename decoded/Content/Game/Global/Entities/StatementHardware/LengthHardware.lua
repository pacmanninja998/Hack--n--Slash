...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\Global\Entities\StatementHardware\LengthHardware.lua 
...
local LengthHardware = Class.create(StatementHardware, "LengthHardware")
LengthHardware.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4, l_1_5, l_1_6, l_1_7, l_1_8)
  ...
  l_1_0:attachInput("crystal", nil, l_1_0.statement, "argument", nil, true)
  l_1_0:attachOutput()
  l_1_0:placeEndWires(-wireDiffX)
end

return LengthHardware
