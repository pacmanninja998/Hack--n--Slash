...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\Global\Entities\StatementHardware\ConcatenateHardware.lua 
...
ConcatenateHardware = Class.create(StatementHardware, "ConcatenateHardware")
ConcatenateHardware.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4, l_1_5, l_1_6, l_1_7)
  ...
  for i = 1, #l_1_0.statement.arguments do
    l_1_0:attachInput(i, l_1_0.statement.arguments, i)
  end
  l_1_0:attachOutput("output", nil, nil, nil, nil, nil, true)
  l_1_0:placeEndWires(-wireDiffX)
end

ConcatenateHardware.attachInput = function(l_2_0, l_2_1, l_2_2, l_2_3)
