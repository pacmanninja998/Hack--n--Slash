...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\Global\Entities\StatementHardware\LoadConstantHardware.lua 
...
local LoadConstantHardware = Class.create(StatementHardware, "LoadConstantHardware")
LoadConstantHardware.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4, l_1_5, l_1_6, l_1_7)
  ...
  l_1_0:setHitboxBody()
  if not l_1_6:is(Decompiler.Constant) or not l_1_6 then
    l_1_0.constantStatement = l_1_6.constant
  end
...
LoadConstantHardware.onFieldSet = function(l_2_0, l_2_1, l_2_2)
