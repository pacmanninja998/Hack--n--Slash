...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\DweebKeep\Entities\Effects\Torch_FrntNS80.lua 

local Entity = require("Entity")
local Shader = require("Shader")
local Torch_FrntNS = require("Class").create(Entity, "Torch_FrntNS")
local SpriteComponent = require("Components.SpriteComponent")
local AnimatorComponent = require("Components.AnimatorComponent")
Torch_FrntNS.FRAMES_PER_SECOND = 15
Torch_FrntNS.ANIM_NAME = "Torch_FrntNS"
Torch_FrntNS.DEFAULT_SCALE = 1
Torch_FrntNS.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
