...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\DweebKeep\Entities\ShiftedLetter.lua 

local Entity = require("Entity")
local Font = require("Font")
local ShiftedLetter = require("Class").create(Entity, "ShiftedLetter")
local PhysicsComponent = require("Components.PhysicsComponent")
ShiftedLetter.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
...
ShiftedLetter.setFontData = function(l_2_0, l_2_1, l_2_2, l_2_3)
