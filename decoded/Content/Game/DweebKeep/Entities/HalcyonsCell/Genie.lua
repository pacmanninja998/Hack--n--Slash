...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\DweebKeep\Entities\HalcyonsCell\Genie.lua 

local Entity = require("Entity")
local LayoutEntity = require("Class").create(Entity, "Genie")
...
LayoutEntity.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
  ...
  animator:enableHitboxBody(true, 0.25)
