...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\DorkForest\Entities\FogRibbon_Ground.lua 

local Entity = require("Entity")
local FogRibbon_Ground = require("Class").create(Entity, "FogRibbon_Ground")
local SpriteComponent = require("Components.SpriteComponent")
local Shader = require("Shader")
FogRibbon_Ground.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
...
FogRibbon_Ground.setDefaultShader = function(l_2_0, l_2_1)
