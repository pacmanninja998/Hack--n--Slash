...
-- Command line was: C:\Users\pacmanninja998\Downloads\luadec51_2.0.2_win32\decode\Content\Game\DorkForest\Entities\Effects\FogRibbon_Thick_CentralForest.lua 

local Entity = require("Entity")
local FogRibbon_Thick_SS = require("Class").create(Entity, "FogRibbon_Thick_SS")
local SpriteComponent = require("Components.SpriteComponent")
local Shader = require("Shader")
FogRibbon_Thick_SS.init = function(l_1_0, l_1_1, l_1_2, l_1_3, l_1_4)
  ...
  sprite.material:setShaderValue("FogStartOffset", MOAIMaterial.VALUETYPE_VEC2, {1.3, 0})
...
FogRibbon_Thick_SS.setDefaultShader = function(l_2_0, l_2_1)
